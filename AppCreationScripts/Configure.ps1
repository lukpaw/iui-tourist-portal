...
Function ConfigureApplications {
    ...
    Write-Host "Creating the AAD application (iui-tourist-portal)"
    # create the application
    $spaAadApplication = New-MgApplication -DisplayName "iui-tourist-portal" `
    ...
    Write-Host "Done creating the spa application (iui-tourist-portal)"
    ...
    Add-Content -Value "<tr><td>spa</td><td>$currentAppId</td><td><a href='$spaPortalUrl'>iui-tourist-portal</a></td></tr>" -Path createdApps.html
    ...
    Write-Host "Updating the sample code ($configFile)"
    $dictionary = @{ "Enter_the_Graph_Endpoint_Here" = "https://graph.microsoft.com/v1.0/me/" };
    UpdateTextFile -configFilePath $configFile -dictionary $dictionary
